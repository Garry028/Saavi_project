    ...
    return (
        <div className="pt-24 mb-10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h1 className="text-4xl font-bold text-red-700 text-center mb-16">BANQUET AND EVENTS</h1>
                <div className="mb-16">
                ...
                <div>
                <h1 className="text-3xl font-bold text-red-700 text-center mb-4">Contact Details</h1>
