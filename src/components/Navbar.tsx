        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-y-2">
          ...
          <div className='items-center justify-between flex flex-col sm:flex-row gap-4'>
            ...
            <div className="flex items-center gap-4 sm:gap-6 whitespace-nowrap overflow-x-auto">
              <a href="https://www.facebook.com/profile.php?id=61565142656404" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors text-white">
                <i className="fab fa-facebook-f text-base"></i>
              </a>
              <a href="https://www.instagram.com/saavihotels?igsh=and4OXdkMTJoNWcx" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors text-white">
                <i className="fab fa-instagram text-base"></i>
              </a>
              <a href="https://www.linkedin.com/company/96062794/admin/dashboard/" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors text-white">
                <i className="fab fa-linkedin-in text-base"></i>
              </a>
              <a href="https://www.youtube.com/@SaaviHotelsAndResorts" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors text-white">
     ...
     <nav className="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-6" aria-label="Global">
       <div className="flex lg:flex-1">
        ...
        <div className="hidden lg:flex items-center justify-between gap-4">
          <Link to="/" className="text-sm font-semibold text-gray-900 py-2 pr-4 hover:text-primary transition-colors">
            Home
          </Link>

          {/* Our Hotels Dropdown */}
          <DropdownMenu open={openDropdown === 'hotels'} onOpenChange={() => handleDropdownClick('hotels')}>
          ...
          {/* About Us Dropdown */}
          <DropdownMenu open={openDropdown === 'about'} onOpenChange={() => handleDropdownClick('about')}>
            <DropdownMenuTrigger className="flex items-center gap-1 border-0 text-sm bg-white font-semibold text-black outline-none focus:outline-none hover:border-0">
            ...
            <DropdownMenuContent className="w-[250px] p-2 bg-white text-black rounded-md shadow-md">
              {[
                ...
                <DropdownMenuItem key={item.name} className="p-2 hover:bg-gray-100 rounded-md focus:outline-none focus:bg-transparent">
                  <Link
                    to={item.href}
          ...
          <Link to="/gallery" className="text-sm font-semibold text-gray-900 py-2 pl-4 pr-6 hover:text-primary transition-colors">
            Gallery
          </Link>

          <Link to="/promotions" className="text-sm font-semibold text-gray-900 py-2 pl-4 pr-6 hover:text-primary transition-colors">
            Promotions
          </Link>

          <Link to="/contact" className="text-sm font-semibold text-gray-900 py-2 pl-4 pr-6 hover:text-primary transition-colors">
            Contact Us
          </Link>

          {/* More Menu Dropdown */}
          <DropdownMenu open={openDropdown === 'more'} onOpenChange={() => handleDropdownClick('more')}>
            <DropdownMenuTrigger className="flex items-center gap-1 border-0 text-sm bg-white font-semibold text-black outline-none focus:outline-none hover:border-0">
...
{isMobileMenuOpen && (
  <div className="lg:hidden bg-white p-4">
    <div className="flex flex-col items-center gap-4">
      ...
      <DropdownMenu open={openDropdown === 'mobile-hotels'} onOpenChange={() => handleDropdownClick('mobile-hotels')}>
        <DropdownMenuTrigger className="flex items-center gap-1 border-0 text-sm bg-white font-semibold text-black outline-none focus:outline-none hover:border-0">
          Our Hotels <ChevronDown className="h-4 w-4" />
        </DropdownMenuTrigger>
      ...
      <DropdownMenu open={openDropdown === 'mobile-about'} onOpenChange={() => handleDropdownClick('mobile-about')}>
        <DropdownMenuTrigger className="flex items-center gap-1 border-0 text-sm bg-white font-semibold text-black outline-none focus:outline-none hover:border-0">
          About Us <ChevronDown className="h-4 w-4" />
        </DropdownMenuTrigger>
        <DropdownMenuContent className="w-full p-2 bg-white">
      ...
      <DropdownMenu open={openDropdown === 'mobile-more'} onOpenChange={() => handleDropdownClick('mobile-more')}>
        <DropdownMenuTrigger className="flex items-center gap-1 border-0 text-sm bg-white font-semibold text-black outline-none focus:outline-none hover:border-0">
          <Menu className="h-6 w-6" />
        </DropdownMenuTrigger>
