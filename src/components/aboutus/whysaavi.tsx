  ...
  return (
    <div className="min-h-screen py-8">
      <div className="container mx-auto px-4 sm:px-8">
        <h1 className="text-3xl font-bold text-red-700 mb-8">Why Choose Saavi Hotels?</h1>

        {/* Why Choose Saavi Cards Section */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h3 className="text-xl font-bold text-red-700 text-center mb-4">Tailored for Corporate Stays</h3>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h3 className="text-xl font-bold text-red-700 text-center mb-4">Strategic Locations</h3>
            <ul className="text-gray-700 space-y-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h3 className="text-xl font-bold text-red-700 text-center mb-4">Exceptional Guest Experience</h3>
            <ul className="text-gray-700 space-y-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h3 className="text-xl font-bold text-red-700 text-center mb-4">Modern Amenities</h3>
            <ul className="text-gray-700 space-y-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h3 className="text-xl font-bold text-red-700 text-center mb-4">Commitment to Quality</h3>
            <ul className="text-gray-700 space-y-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h3 className="text-xl font-bold text-red-700 text-center mb-4">Sustainability</h3>
            <ul className="text-gray-700 space-y-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h3 className="text-xl font-bold text-red-700 text-center mb-4">Value for Money</h3>
            <ul className="text-gray-700 space-y-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h3 className="text-xl font-bold text-red-700 text-center mb-4">Trusted Leadership</h3>
            <ul className="text-gray-700 space-y-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h3 className="text-xl font-bold text-red-700 text-center mb-4">Safety and Security</h3>
            <ul className="text-gray-700 space-y-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h3 className="text-xl font-bold text-red-700 text-center mb-4">A Brand That Cares</h3>
            <ul className="text-gray-700 space-y-4">
